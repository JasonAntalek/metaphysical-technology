...
description: The final answer may look like the AI’s work. The record shows how Human judgment, AI contribution, and shared context shaped what became possible.
...
Human-AI research recognizes that interaction changes across time. Microsoft Research’s [Guidelines for Human-AI Interaction](https://www.microsoft.com/en-us/research/publication/guidelines-for-human-ai-interaction/) addresses first encounters, regular interaction, moments when the system is wrong, and behavior over time.
...
The [NIST AI Risk Management Framework](https://airc.nist.gov/airmf-resources/airmf/5-sec-core/) calls for Human-AI roles and responsibilities to be differentiated. It also treats context, feedback, documentation, and change over time as important to evaluation. NIST’s [human-AI interaction appendix](https://airc.nist.gov/airmf-resources/airmf/appendices/app-c-ai-risk-management-and-human-ai-interaction/) notes that results can vary across Human-AI configurations.
...
Within [Metaphysical Technology](https://jasonantalek.github.io/metaphysical-technology/category/), the Field can name the relational atmosphere or interaction ecology present in the encounter.
...
- Amershi, Saleema, et al. [Guidelines for Human-AI Interaction](https://www.microsoft.com/en-us/research/publication/guidelines-for-human-ai-interaction/). CHI 2019.
- National Institute of Standards and Technology. [Artificial Intelligence Risk Management Framework Core](https://airc.nist.gov/airmf-resources/airmf/5-sec-core/) and [Appendix C: AI Risk Management and Human-AI Interaction](https://airc.nist.gov/airmf-resources/airmf/appendices/app-c-ai-risk-management-and-human-ai-interaction/).
