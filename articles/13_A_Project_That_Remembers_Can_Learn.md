...
description: Files preserve activity. Learning requires a record of what changed, why it changed, and what the project now knows.
permalink: /articles/a-project-that-remembers-can-learn/
article_order: 13
previous_url: /articles/the-ai-didnt-produce-the-result-the-relationship-did/
previous_title: The AI Didn't Produce the Result. The Relationship Did.
---
...
The World Wide Web Consortium’s [PROV standard](https://www.w3.org/TR/prov-o/) provides a technical model for describing where something came from, which activity produced it, who held responsibility, and whether one record was derived from or revised from another.
...
The [NIST Research Data Framework](https://www.nist.gov/programs-projects/research-data-framework-rdaf) places preservation and discard within the research-data lifecycle. The National Academies’ [Open Science by Design](https://www.nationalacademies.org/read/25116/chapter/8) recognizes that long-term stewardship requires resources and concludes that not all data and research products should be preserved for the long term.
...
For [Metaphysical Technology](https://jasonantalek.github.io/metaphysical-technology/category/), cumulative knowledge depends on that continuity. Technical behavior, Human experience, AI contribution, interpretation, and the Field cannot remain distinct across time if their relationships disappear from the record.
...
- [What Happens When Belief Becomes Infrastructure?](https://jasonantalek.github.io/metaphysical-technology/articles/what-happens-when-belief-becomes-infrastructure/)
- [Claims and Evidence](https://jasonantalek.github.io/metaphysical-technology/evidence/)

## Sources

- World Wide Web Consortium. [PROV-O: The PROV Ontology](https://www.w3.org/TR/prov-o/). W3C Recommendation, April 30, 2013.
- National Institute of Standards and Technology. [Research Data Framework](https://www.nist.gov/programs-projects/research-data-framework-rdaf). Version 2.0; page updated March 26, 2025.
- National Academies of Sciences, Engineering, and Medicine. [Open Science by Design: Realizing a Vision for 21st Century Research](https://www.nationalacademies.org/read/25116/chapter/8). National Academies Press, 2018. [https://doi.org/10.17226/25116](https://doi.org/10.17226/25116).
